...
function header() {
    ...
    main.appendChild(header);
     header.setAttribute("class","d-flex bg-dark");
    let logo = document.createElement("div");
    logo.setAttribute("class","d-flex flex-column mt-1");
    logo.setAttribute("style","width:25%;")    
    header.appendChild(logo);
    let span1 = document.createElement("span");
    span1.setAttribute("class","text-white");
    span1.innerHTML="<i class = 'text-danger '>E-</i>shop";
     let span2 = document.createElement("span");
     logo.appendChild(span1);
    // span2.setAttribute("class","text-white ")
    // // span2.innerText="Products in one Tap";
    // logo.appendChild(span2);


    let search = document.createElement("div");
    search.setAttribute("style","width:50%;");
    header.appendChild(search);
    let input1 = document.createElement("input");
    input1.setAttribute("type","search");
    input1.setAttribute("class","rounded mt-1 px-2")
    input1.setAttribute("placeholder","Search by Title");
    input1.setAttribute("style","width:100%;border:2px solid white");
    search.appendChild(input1);

    let account = document.createElement("div");
    account.setAttribute("style","width:25%;");
    account.setAttribute("class","d-flex flex-row justify-content-evenly ")
    header.appendChild(account);
    let signup = document.createElement("span");
    signup.setAttribute("class","text-white btn")
    signup.innerText="SignUp";
    account.appendChild(signup)
    let signin = document.createElement("span");
    signin.setAttribute("class","text-white btn")
...
function card() {
 ...
 for(let a of d){
    ...
    col.setAttribute("class","col-md-4 col-sm-2   mt-5 d-flex flex-column");
    // col.setAttribute("style","box-shadow:2px 3px 8px 2px gray;");
    row.appendChild(col);


    let inner = document.createElement("div");
    inner.setAttribute("class","d-flex flex-column rounded p-1 ")
    inner.setAttribute("style","box-shadow:2px 3px 8px 2px rgb(204, 198, 200);height:100%")
    ...
    // category.innerText = `Category: ${a.category}`;
    
    let brand = document.createElement("span");
    brand.setAttribute("class","");
    inner.appendChild(brand);
    brand.innerHTML = `<i>Brand:  ${a.brand}<i>`;

    // let rating = document.createElement("span");
    // rating.setAttribute("class","");
    // col.appendChild(rating);
    // rating.innerText = `Rating: ${a.rating}`;
